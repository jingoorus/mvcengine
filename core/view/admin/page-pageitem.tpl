<div id="pageEditor">
    <h3>Editing pageitem "{item}" in "{title}"</h3>
    ...
    <form method="POST" action="/admin/savepageitem/?page={title}&amp;item={item}">
        ...
        <div class="row">
            ...
            <div class="col-sm-3"><a href="/admin/deletepageitem/?page={title}&amp;item={item}" type="button" class="btn btn-block btn-danger"> !Delete </a></div>
        </div>
    </form>
    <br />
    <br />
